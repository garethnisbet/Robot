# -*- coding: utf-8 -*-
"""
Robot/Device — remote control client library

RobotClient drives the viewer over its WebSocket API. Works with any device
config (Meca500, i16 diffractometer, etc.). It needs no terminal: import it
from a script or a test. robot_ipython.py wraps it in an IPython shell.

Usage:
    from robot_client import RobotClient
    robot = RobotClient(url="ws://localhost:8080/ws", config="meca500_config.json")
"""
