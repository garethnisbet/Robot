...
MotoMini_kin = kinematics.kinematics.from_home_positions(
    v0=np.array([20, 0, 171]),
    v1=np.array([20, 0, 336]),
    v2=np.array([60, 0, 336]),
    v3=np.array([185, 0, 336]),
    v4=np.array([225, 0, 336]),
    motor_limits=np.array([[-180, 180], [-60, 76], [-77.8, 197],
                            [-360, 360], [-125, 125], [-360, 360]]),
    centre_offset=[0, 0, 0],
    tool_offset=[0, 0, 0],
